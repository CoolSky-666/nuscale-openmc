...
state_dir = Path("./data/RE1d5in")
out_fig9 = Path("./figs/err_fig9_cr.png")
out_fig10 = Path("./figs/err_fig10_cr.png")
out_fig11 = Path("./figs/err_fig11_cr.png")
...
df_rad_ref = pd.read_excel(xlsx_path, sheet_name="rad_pow_CR", header=None, usecols="A:G", nrows=7)
rad_ref = df_rad_ref.to_numpy(dtype=float)

df_pin_ref = pd.read_excel(xlsx_path, sheet_name="pin_pow_CR", header=None, usecols="B:DP", nrows=119)
